...
### Fixed
- **Python**: Added explicit Python 3.9-3.12 classifiers to fix shields.io badges and ensure better categorization on PyPI.

## [0.3.1] - 2026-02-28

### Fixed
- **Python**: Resolved empty project description and missing project links on PyPI by explicitly defining metadata in `pyproject.toml`.
